    ...
    return (
      <MainLayout>
        <div className="min-h-[50vh] flex flex-col items-center justify-center">
          ...
          <Link to="/about">
            <Button>Kembali ke About</Button>
          </Link>
        </div>
      </MainLayout>
    );
  ...
  return (
    <MainLayout>
      <section className="bg-[#f9f9f9] py-[64px]">
        <div className="w-[90%] max-w-[1140px] mx-auto flex flex-col md:flex-row items-center gap-[32px] md:pl-[130px]">
        ...
        <div className="mb-[2.5rem] text-justify">
          ...
          <ul className="list-disc pl-[20px] space-y-2">
            {person.skills.map((skill: string, idx: number) => (
              <li
                key={idx}
                className="font-inter text-[1rem] leading-[1.7] text-dark"
              >
                {skill}
              </li>
            ))}
