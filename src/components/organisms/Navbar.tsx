    ...
    <header className="w-full relative z-50 transition-all duration-300 fixed top-0 left-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          >
            <span
              className={`block w-full h-[3px] bg-gray-900 rounded transition-all duration-300 origin-center ${isOpen ? "rotate-45 translate-y-[9px]" : ""}`}
            ></span>
            <span
              className={`block w-full h-[3px] bg-gray-900 rounded transition-all duration-300 ${isOpen ? "opacity-0" : ""}`}
            ></span>
            <span
              className={`block w-full h-[3px] bg-gray-900 rounded transition-all duration-300 origin-center ${isOpen ? "-rotate-45 -translate-y-[9px]" : ""}`}
            ></span>
