...
export default function Dashboard() {
  // ... state & logic fetch courses tetap sama persis ...
  ...
  // GUNAKAN DASHBOARD LAYOUT DI SINI
  return (
    <DashboardLayout>
       {/* Header Section */}
       <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900 font-lexend">Marketplace Kursus</h1>
          <p className="text-gray-500 text-sm mt-1">Jelajahi ilmu baru hari ini.</p>
       </div>
