  ...
  return (
    <DashboardLayout>
      <div className="flex justify-between items-center mb-8">
        <div>
           <h1 className="text-2xl font-bold font-lexend text-gray-900">Studio Creator</h1>
           <p className="text-gray-500 text-sm">Kelola kursus dan pantau perkembangan siswamu.</p>
        </div>
        <Link 
            ...
            <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-gray-100 text-sm">
                    {loading ? (
                        ...
                        <tr><td colSpan={5} className="p-8 text-center text-gray-500">Belum ada kursus dibuat.</td></tr>
                    ) : (
                        courses.map((course) => (
                            <tr key={course._id} className="hover:bg-gray-50 transition-colors">
                                <td className="p-5">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="font-bold text-gray-900 line-clamp-1 max-w-[200px]">{course.title}</span>
                                    </div>
                                </td>
                                <td className="p-5 font-medium">{formatPrice(course.price)}</td>
                                <td className="p-5">
